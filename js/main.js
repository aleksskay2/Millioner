...
let questions = [
    ...
    {
        question:'Кто написал произведение Руслан и Людмила?',
        first: 'Лермонтов',
        second: 'Толстой ',
        third: 'Тургенев',
        forth: 'Пушкин',
    ...
    {
        question:'Как звучит имя Ньютона?',
        first: 'Исаак',
        second: 'Альберт',
        third: 'Карл',
        forth: 'Джон',
    ...
    {
        question:'Кто ввел в науке понятие "электромагнитное поле"?',
        first: 'Ом',
        second: 'Паскаль',
        third: 'Резерфорд',
        forth: 'Максвелл',
...
for(let item of variants){
    item.addEventListener('click', () => {
        ...
        let right = nextAnswer(item.innerText);
        if (right) 
        setTimeout(() => {
...
procent.addEventListener('click', () => {
    if (fiftyFifty === false) {
        ...
        while (((questions[countQuestion].right === first.innerText && twoNumbers[0] === 2) || 
        (questions[countQuestion].right=== first.innerText &&  twoNumbers[1] === 2)) || 

        ((questions[countQuestion].right === second.innerText && twoNumbers[0] === 2) || 
        (questions[countQuestion].right=== second.innerText &&  twoNumbers[1] === 2)) ||

        ((questions[countQuestion].right === third.innerText && twoNumbers[0] === 2) || 
        (questions[countQuestion].right=== third.innerText &&  twoNumbers[1] === 2)) ||

        ((questions[countQuestion].right === forth.innerText && twoNumbers[0] === 2) || 
        (questions[countQuestion].right=== forth.innerText &&  twoNumbers[1] === 2)) 
        ) 
        {
